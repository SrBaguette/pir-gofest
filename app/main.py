...
async def diagnostico(request: Request):
    ...
    Cualquier canal (Web, WhatsApp, etc.) usa este endpoint o el webhook.
    """
...
async def webhook_whatsapp(request: Request):
    """
    Webhook Twilio para mensajes entrantes de WhatsApp.
...
def integracion_twilio():
    """Estado de la integración WhatsApp/Twilio y variables requeridas."""
...
def demo_seed(cantidad: int = 100, reemplazar: bool = False):
    """
    Genera casos demostrativos anonimizados para poblar el dashboard.
    Uso: POST /demo/seed?cantidad=100&reemplazar=true
    """
